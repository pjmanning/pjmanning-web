<template>
    <footer class="text-white bg-gray-800">
        <div class="container flex flex-col items-center justify-between mx-auto py-8 lg:flex-row">
            <div class="mb-8 lg:mb-0">
                <div>Copyright {{ new Date().getFullYear() }}. All rights reserved.</div>
                <div>
                    <a href="/rss.xml" class="hover:text-gray-400 text-white font-normal">RSS Feed</a>
                    |
                    <a href="/sitemap.xml" class="hover:text-gray-400 text-white font-normal">Sitemap</a>
                    |
                    <a href="https://www.getrevue.co/profile/pjmanning" target="_blank" class="hover:text-gray-400 text-white font-normal"> Newsletter </a>
                </div>
            </div>
            <ul class="flex items-center">
                <li class="mr-8">
                    <a href="https://www.youtube.com/channel/UCX0zkbdpllaa3h-OZsJhSLQ" target="_blank" class="hover:text-gray-400 text-white">
                ...
                <li class="mr-8">
                    <a href="https://github.com/pjmanning" target="_blank" class="hover:text-gray-400 text-white">
                ...
                <li class="mr-8">
                    <a href="https://twitter.com/pj_manning" target="_blank" class="hover:text-gray-400 text-white">
                ...
                <li class="mr-8">
                    <a href="https://instagram.com/philmanning_" target="_blank" class="hover:text-gray-400 text-white">
                ...
                <li class="mr-8">
                    <a href="https://www.behance.net/philmanning" target="_blank" class="hover:text-gray-400 text-white">
                ...
                <li class="mr-5">
                    <a href="https://medium.com/@pjmanning" target="_blank" class="hover:text-gray-400 text-white">
